...
export class WithdrawSwiftFail extends React.Component<
...
> {
  ...
  private handleTryAgain = (e: any) => {
    e.preventDefault();
    this.props.history.replace(ROUTE_WITHDRAW_SWIFT_FROM(this.assetId));
  };
}

export default inject(STORE_ROOT)(observer(WithdrawSwiftFail));
